		...
		<div className="rounded-sm border border-zinc-200 bg-white px-3 py-2 shadow-lg dark:border-zinc-700 dark:bg-zinc-900">
			...
			<div className="space-y-1 text-sm">
				<div className="flex items-center justify-between gap-4">
					...
					<span className="font-medium">{formatLatency(data.avg_overhead)}</span>
				</div>
				<div className="flex items-center justify-between gap-4">
					<span className="flex items-center gap-1.5">
					...
					<span className="font-medium">{formatLatency(data.p90_overhead)}</span>
				</div>
				<div className="flex items-center justify-between gap-4">
					<span className="flex items-center gap-1.5">
					...
					<span className="font-medium">{formatLatency(data.p95_overhead)}</span>
				</div>
				<div className="flex items-center justify-between gap-4">
					<span className="flex items-center gap-1.5">
					...
					<span className="font-medium">{formatLatency(data.p99_overhead)}</span>
				</div>
